...
<div style="text-align: right; margin-top: 20px;">
    <a href="{{ route('production.show', $data->wo_number) }}" class="btn btn-secondary" style="padding: 10px 15px; background-color: #6c757d; color: white; text-decoration: none; border-radius: 5px;">
